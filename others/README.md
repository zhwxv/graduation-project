...
E.g.
_
`python train_all.py  --data_path data/xxx.csv  --dataset_type classification  --save_path model_save  --log_path log`
...
## Contact
If you have any question, please contact us: mm1016@qhnu.edu.cnpython hyper_opti.py  --data_path data/test.csv  --dataset_type classification  --save_path model_save  --log_path log